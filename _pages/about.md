...
.feature__item .archive__item-body {
  ...
  border: 1px solid rgba(155, 196, 209, 0.40);
  border-top: 5px solid rgba(155, 196, 209, 0.72);
  display: flex;
  flex-direction: column;
...
.btn--primary {
  ...
  border-color: rgba(155, 196, 209, 0.72) !important;
  color: #2E676B !important;
}
.btn--primary:hover {
  background-color: #5E9DA1 !important;
  border-color: #5E9DA1 !important;
  color: #fff !important;
}
/* Muted "Coming soon" card (JMP1) */
.feature__item:nth-child(1) .archive__item-body {
  border-color: rgba(155, 196, 209, 0.24);
  border-top-color: rgba(155, 196, 209, 0.44);
  opacity: 0.65;
}
...
.btn--disabled {
  ...
  border-color: rgba(155, 196, 209, 0.24) !important;
